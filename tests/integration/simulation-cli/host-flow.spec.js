...
import { obtenerMetricas, verActividadReciente } from '../../../simulation-cli/hosts/admin.cli.js';
import {
  createMockCli,
...
describe('Integración de hosts simulados', () => {
  ...
  it('Eventos de distintos hosts aparecen en actividad de Admin', async () => {
    await despachoHandleOption('1', createMockCli(['Remitente QA', 'Destino QA']));
    await atencionHandleOption('1', createMockCli(['Cliente QA', 'Consulta de estado']));
